...
> "aspect_ratios": ["16:9", "9:16"], "resolutions": ["480p", "720p"]}`)
> que limita la cantidad de videos por generación, el rango de duración en
> segundos y los formatos de salida soportados; se aplica en `GenerateUnified`
> vía `enforceVideoLimits` (ver `model_config.go`).
